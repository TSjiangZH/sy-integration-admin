  ...
  <div class="app-container">
    <el-card>
      <div slot="header" class="clearfix">
        ...
        <el-button size="small" @click="toggleOrderType" style="margin-left: 8px;">
...
export default {
  ...
  methods: {
    async fetchList(page = 1) {
      try {
        this.page = page
        const res = await fetchBlogList({ page, pageSize: this.pageSize, orderField: this.orderField, orderType: this.orderType })
